...
BASIC_LIB_PP_API T_status blpp_Lzma_UncompressData(PBLPP_LZMA_UNCOMPRESS_REQUST pLUR);
BASIC_LIB_PP_API T_status blpp_Lzma_CompressData(PBLPP_LZMA_COMPRESS_REQUST pLCR);
...
BASIC_LIB_PP_API T_status blpp_Lzma_StreamCompress(PT_void lparam,T_Qword allLength,__pfn_blpp_Lzma_Read pRead,__pfn_blpp_Lzma_Write pWrite,T_Bit8u level /* 0 <= level <= 9 */);
BASIC_LIB_PP_API T_status blpp_Lzma_StreamUncompress(PT_void lparam,__pfn_blpp_Lzma_Read pRead,__pfn_blpp_Lzma_Write pWrite);
