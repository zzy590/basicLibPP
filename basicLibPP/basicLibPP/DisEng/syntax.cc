...
void disassembler::initialize_modrm_segregs()
{
  ...
  // For my data.
  sreg_mod00_rm16_r[0] = R_DS;
  sreg_mod00_rm16_r[1] = R_DS;
  sreg_mod00_rm16_r[2] = R_SS;
  sreg_mod00_rm16_r[3] = R_SS;
  sreg_mod00_rm16_r[4] = R_DS;
  sreg_mod00_rm16_r[5] = R_DS;
  sreg_mod00_rm16_r[6] = R_DS;
  sreg_mod00_rm16_r[7] = R_DS;

  sreg_mod01or10_rm16_r[0] = R_DS;
  sreg_mod01or10_rm16_r[1] = R_DS;
  sreg_mod01or10_rm16_r[2] = R_SS;
  sreg_mod01or10_rm16_r[3] = R_SS;
  sreg_mod01or10_rm16_r[4] = R_DS;
  sreg_mod01or10_rm16_r[5] = R_DS;
  sreg_mod01or10_rm16_r[6] = R_SS;
  sreg_mod01or10_rm16_r[7] = R_DS;

  sreg_mod00_base32_r[0]  = R_DS;
  sreg_mod00_base32_r[1]  = R_DS;
  sreg_mod00_base32_r[2]  = R_DS;
  sreg_mod00_base32_r[3]  = R_DS;
  sreg_mod00_base32_r[4]  = R_SS;
  sreg_mod00_base32_r[5]  = R_DS;
  sreg_mod00_base32_r[6]  = R_DS;
  sreg_mod00_base32_r[7]  = R_DS;
  sreg_mod00_base32_r[8]  = R_DS;
  sreg_mod00_base32_r[9]  = R_DS;
  sreg_mod00_base32_r[10] = R_DS;
  sreg_mod00_base32_r[11] = R_DS;
  sreg_mod00_base32_r[12] = R_DS;
  sreg_mod00_base32_r[13] = R_DS;
  sreg_mod00_base32_r[14] = R_DS;
  sreg_mod00_base32_r[15] = R_DS;

  sreg_mod01or10_base32_r[0]  = R_DS;
  sreg_mod01or10_base32_r[1]  = R_DS;
  sreg_mod01or10_base32_r[2]  = R_DS;
  sreg_mod01or10_base32_r[3]  = R_DS;
  sreg_mod01or10_base32_r[4]  = R_SS;
  sreg_mod01or10_base32_r[5]  = R_SS;
  sreg_mod01or10_base32_r[6]  = R_DS;
  sreg_mod01or10_base32_r[7]  = R_DS;
  sreg_mod01or10_base32_r[8]  = R_DS;
  sreg_mod01or10_base32_r[9]  = R_DS;
  sreg_mod01or10_base32_r[10] = R_DS;
  sreg_mod01or10_base32_r[11] = R_DS;
  sreg_mod01or10_base32_r[12] = R_DS;
  sreg_mod01or10_base32_r[13] = R_DS;
  sreg_mod01or10_base32_r[14] = R_DS;
  sreg_mod01or10_base32_r[15] = R_DS;
}
...
{
  // print opcode
  pDecomposed->OpcodeType = entry->Feature;
  pDecomposed->Opcode = entry->Opcode;
  ...
  pDecomposed->OperandUsed = (unsigned __int32)(pOperand-pDecomposed->Operand);
}
