...
public:
  ...
  x86_insn decode(bx_bool is_32, bx_bool is_64, bx_address cs_base, bx_address ip, const Bit8u *instr, char *disbuf, PDisEng_DECOMPOSED decomposed);

  x86_insn decode16(bx_address cs_base, bx_address ip, const Bit8u *instr, char *disbuf, PDisEng_DECOMPOSED decomposed)
    { return decode(0, 0, cs_base, ip, instr, disbuf, decomposed); }

  x86_insn decode32(bx_address cs_base, bx_address ip, const Bit8u *instr, char *disbuf, PDisEng_DECOMPOSED decomposed)
    { return decode(1, 0, cs_base, ip, instr, disbuf, decomposed); }

  x86_insn decode64(bx_address cs_base, bx_address ip, const Bit8u *instr, char *disbuf, PDisEng_DECOMPOSED decomposed)
    { return decode(1, 1, cs_base, ip, instr, disbuf, decomposed); }
...
private:
  ...
  DisEng_SegmentReg sreg_mod00_base32_r[16];
  DisEng_SegmentReg sreg_mod01or10_base32_r[16];
  DisEng_SegmentReg sreg_mod00_rm16_r[8];
  DisEng_SegmentReg sreg_mod01or10_rm16_r[8];
